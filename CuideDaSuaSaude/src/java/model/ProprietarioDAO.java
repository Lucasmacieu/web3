...
public class ProprietarioDAO {
    ...
    public ArrayList<Proprietario> listProprietario() throws SQLException {
        ...
        while(result.next()) {
            ...
            proprietario.setTipo(result.getString("tipo_sanguineo"));
            proprietario.setNumero(result.getInt("colesterol"));
    ...
    public void insertProprietario(Proprietario pro) throws SQLException {
        ...
        String query = "INSERT INTO proprietarios(nome, cpf, tipo_sanguineo, colesterol, numero, cep, cidade, senha)"
                + "VALUES(?,?,?,?,?,?,?,?)";
        ...
        prep.setString(3, pro.getTipo());
        prep.setInt(4, pro.getColesterol());
        prep.setInt(5, pro.getNumero());
        prep.setString(6, pro.getCep());
        prep.setString(7, pro.getCidade());
        prep.setString(8, pro.getSenha());
    ...
    public Proprietario listById(int id) throws SQLException {
        ...
        if(result.next()) {
            ...
            p.setTipo(result.getString("tipo_sanguineo"));
            p.setNumero(result.getInt("colesterol"));
    ...
    public Proprietario listByName(String nome) throws SQLException {
        Proprietario p = new Proprietario();
    ...
    public void updateProprietario(Proprietario p) throws SQLException {
        ...
        prep.setString(3, p.getTipo());
        prep.setInt(4, p.getColesterol());
        prep.setInt(5, p.getNumero());
        prep.setString(6, p.getCep());
        prep.setString(7, p.getCidade());
        prep.setInt(8, p.getIdProprietario());
